// lib/components/driving_license/driving_license_card_view.dart
import 'package:e_govermenet/components/services/api_constants.dart';
import 'package:flutter/material.dart';

class DrivingLicenseCardView extends StatelessWidget {
  final String citizenImagePath;
  final String plateNumber; // Or License Number
  final String fullName;
  final String gender;
  final String dob;
  final String issuedDate;
  final String expiryDate;
  final bool isExpired; // Added for visual cue

  const DrivingLicenseCardView({
    super.key,
            ...
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  image: const DecorationImage( // Replace with your actual flag URL or asset
                    image: NetworkImage("https://upload.wikimedia.org/wikipedia/commons/thumb/a/a0/Flag_of_Somalia.svg/125px-Flag_of_Somalia.svg.png"),
                    fit: BoxFit.cover,
                  ),
                ),
              ),
              ...
              const Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Text("Driver's License / Liisanka Gaadiidka", style: TextStyle(fontSize: 9, fontWeight: FontWeight.w500, color: Colors.blueGrey), textAlign: TextAlign.center),
                  ],
                ),
              ),
               if (isExpired)
            ...
            children: [
              Expanded(
                ...
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    _buildInfoItem("License No:", plateNumber),
                    ...
                    decoration: BoxDecoration(
                      ...
                      image: citizenImagePath.isNotEmpty
                          ? DecorationImage(
                              ...
                              fit: BoxFit.cover,
                              onError: (exception, stackTrace) => const Icon(Icons.person, size: 50, color: Colors.grey),
                            )
                          : null,
